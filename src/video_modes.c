...
const VideoMode g_modes[] = {
    ...
    { "VGA 800x600 56Hz",   VGA_SIGNAL, GS_MODE_VGA_800_56,  NI, FRAME,  800,  600, GS_PSM_CT32, ON  },
    { "VGA 800x600 60Hz",   VGA_SIGNAL, GS_MODE_VGA_800_60,  NI, FRAME,  800,  600, GS_PSM_CT32, ON  },
    { "VGA 800x600 72Hz",   VGA_SIGNAL, GS_MODE_VGA_800_72,  NI, FRAME,  800,  600, GS_PSM_CT32, ON  },
    { "VGA 800x600 75Hz",   VGA_SIGNAL, GS_MODE_VGA_800_75,  NI, FRAME,  800,  600, GS_PSM_CT32, ON  },
    { "VGA 800x600 85Hz",   VGA_SIGNAL, GS_MODE_VGA_800_85,  NI, FRAME,  800,  600, GS_PSM_CT32, ON  },
